...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'idusuario', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'tipoUsuariotipoUsuario', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'departamentodepartamento'];
        }
    ...
    public function setTipoUsuariotipoUsuario(\AppBundle\Entity\TipoUsuario $tipoUsuariotipoUsuario = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoUsuariotipoUsuario', [$tipoUsuariotipoUsuario]);

        return parent::setTipoUsuariotipoUsuario($tipoUsuariotipoUsuario);
    }
    ...
    public function getTipoUsuariotipoUsuario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoUsuariotipoUsuario', []);

        return parent::getTipoUsuariotipoUsuario();
    }
